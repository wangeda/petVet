        ...
        <form method="POST" action="{{url('/customers')}}">
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" name="first_surname" id="first_surname"
                        placeholder="@lang('First Surname')..." value="{{old('first_surname')}}">
                    @error('first_surname')
                    <strong class="invalid"> {{ $message}}</strong>
                    @enderror
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" name="second_surname" id="second_surname"
                        placeholder="@lang('Second Surname')..." value="{{old('second_surname')}}">
                </div>
            </div>
            <div class="form-group row">
                <!--dni-->
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="dni" id="dni" placeholder="@lang('DNI')"
                        value="{{old('dni')}}">
                    @error('dni')
                    <strong class="invalid"> {{ $message}}</strong>
                    @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="CP" id="CP" placeholder="@lang('Postal Code')"
                        value="{{old('CP')}}">
                    @error('CP')
                    <strong class="invalid"> {{ $message}}</strong>
                    @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="phone" id="phone" placeholder="@lang('Phone')"
                        value="{{old('phone')}}">
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="@lang('Mobile')"
                        value="{{old('mobile')}}">
                    @error('mobile')
                    <strong class="invalid"> {{ $message}}</strong>
                    @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="btn" style=" color:#38d3b0; border-color:#38d3b0; font-weight:bold"
                        ...
                        onmouseover="this.style.backgroundColor='#38d3b0'; this.style.color='#FFF';" type="submit"
                        value="@lang('Save')">
                </div>
                <!--Volver sin cambios-->
                <div class="col-sm-6 d-flex flex-row-reverse">
                    <a class="btn btn-outline-danger" href="{{ url('/customers')}}" type="button"
                        onmouseover="this.style.color='white';" onmouseout="this.style.color='red';"> @lang('Back
                        without saving')</a>
                </div>
            </div>
        </form>
